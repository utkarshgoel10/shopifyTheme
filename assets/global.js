...
class MenuDrawer extends HTMLElement {
  ...
  openMenuDrawer(summaryElement) {
    if(summaryElement.classList.contains("mobile-facets__open-wrapper")){
      document.getElementById('shopify-section-announcement-bar')?.classList.add('shopify-section-header-hide')
      document.getElementById('shopify-section-header')?.classList.add('shopify-section-header-hide')
    }
    setTimeout(() => {
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    if(this.classList.contains("mobile-facets__wrapper")){
      document.getElementById('shopify-section-announcement-bar')?.classList.remove('shopify-section-header-hide')
      document.getElementById('shopify-section-header')?.classList.remove('shopify-section-header-hide')
    }
...
class FlickityCarousel extends HTMLElement {
  constructor() {
    super();
    this.initFlickity(this.dataset.flickityOptions);
  }
  initFlickity(options) {
    console.log(JSON.parse(options))
    this.flkty = new Flickity(this,JSON.parse(options));
  }
}
...
// Testimonial Slider
  ...
  const testimonialSlider = new Flickity('.customer-testimonials__reviews-wrapper',flickityConfig);
});
